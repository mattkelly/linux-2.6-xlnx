...
#define MM 216 /* offsetof(struct task_struct, mm)	 # */
#define MMCONTEXTID 380 /* offsetof(struct mm_struct, context.id)	 # */
...
#define THREAD_FPEXC_MODE 296 /* offsetof(struct thread_struct, fpexc_mode)	 # */
#define THREAD_FPR0 32 /* offsetof(struct thread_struct, fpr[0])	 # */
#define THREAD_FPSCR 288 /* offsetof(struct thread_struct, fpscr)	 # */
